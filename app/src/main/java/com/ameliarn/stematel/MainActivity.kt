...
import com.example.myintentapp.MoveForResultActivity
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.btn_move_activity_object -> {
                val person = Person(
                    "Amelia Rachma Nurhidayat",
                    16,
                    "ameliaarnn12@gmail.com",
                    "Purwokerto"
                )
